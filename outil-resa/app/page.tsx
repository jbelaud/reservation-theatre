      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 font-bold text-xl text-primary">
            <Image src="/icon.png" alt="Resavo Logo" width={32} height={32} className="rounded-md" />
            <span>Resavo</span>
          </div>
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            <Link href="#fonctionnalites" className="hover:text-primary transition-colors">Fonctionnalités</Link>
            <Link href="#tarif" className="hover:text-primary transition-colors">Tarif</Link>
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" asChild className="hidden sm:inline-flex text-primary hover:text-primary/80 hover:bg-primary/5">
              <Link href="/connexion">Espace Asso</Link>
            </Button>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight">
                Gérez les réservations de votre spectacle <span className="text-primary">simplement</span>.
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Button size="lg" asChild className="w-full sm:w-auto text-lg h-12 px-8 bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20">
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <div>
                  ...
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-start gap-3 text-slate-600">
                      ...
                      <span>Les erreurs de comptage.</span>
                    </li>
                    <li className="flex items-start gap-3 text-slate-600">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-slate-900 mb-6 text-primary">Avec Resavo !</h2>
                  <ul className="space-y-4">
        ...
        <section id="tarif" className="py-24 bg-slate-50">
          <div className="container mx-auto px-4">
            <div className="max-w-lg mx-auto">
              <Card className="border-primary/10 shadow-xl bg-white overflow-hidden relative">
            ...
            <div className="max-w-3xl mx-auto text-center space-y-8">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-8 text-left shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex-1 space-y-2 text-center md:text-left">
                  ...
                  <div className="pt-2">
                    <a 
                      ...
                      className="text-lg font-medium text-primary hover:underline flex items-center justify-center md:justify-start gap-2"
                    >
                ...
                <div className="hidden md:block">
                  <Button asChild size="lg" className="bg-white text-primary border-2 border-primary hover:bg-primary/5">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-8 text-center md:text-left">
          <div>
            <div className="flex items-center justify-center md:justify-start gap-2 font-bold text-xl text-white mb-4">
              <Image src="/icon.png" alt="Resavo Logo" width={24} height={24} className="rounded-sm brightness-0 invert" />
              <span>Resavo</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#tarif" className="hover:text-primary transition-colors">Tarifs</Link></li>
              <li><Link href="/connexion" className="hover:text-primary transition-colors">Espace Association</Link></li>
              <li><Link href="/blog" className="hover:text-primary transition-colors font-medium text-white">Blog</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="mailto:ets.belaud@gmail.com" className="hover:text-primary transition-colors">ets.belaud@gmail.com</a></li>
              <li>France</li>
            </ul>
          </div>
        </div>
