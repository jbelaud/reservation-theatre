                ...
                <PopoverTrigger asChild>
                    <div className={cn(
                        ...
                        <div className={cn("text-left overflow-hidden", isSidebar ? "flex-1" : "hidden sm:block")}>
                            {!isSidebar && <span className="block text-sm font-medium text-gray-900">Bonjour, {associationName}</span>}
                            {isSidebar && <span className="block text-sm font-bold text-gray-900 truncate">{associationName}</span>}
